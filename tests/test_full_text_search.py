...
from vids_db_server.db_full_text_search import DbFullTextSearch
...
class DbFullTextSearchTester(unittest.TestCase):
    ...
    def setUp(self) -> None:
        ...
        cleanup_fcn = lambda: shutil.rmtree(self.tempdir, ignore_errors=True)
        atexit.register(cleanup_fcn)
